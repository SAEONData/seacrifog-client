export default [
  {
    ...
    fixed: true,
    id: 1,
    logo: `${process.env.PUBLIC_PATH}/eu-funding-achnowledgement.jpg`,
  ...
  },
  {
    ...
    fixed: true,
    id: 2,
    logo: `${process.env.PUBLIC_PATH}/seacrifog-logo.png`,
    alt: 'SEACRIFOG logo',
    content:
  ...
  },
  {
    name: 'INDP',
    id: 3,
    logo: `${process.env.PUBLIC_PATH}/indp.jpg`,
    alt: 'INDP logo',
    content: 'National Fisheries Development Institute',
    href: 'http://www.cvoo.de/'
  },
  {
    name: 'Lund University',
    id: 4,
    logo: `${process.env.PUBLIC_PATH}/csm_lu_logo_b95e6f4e46.png`,
  ...
  },
  {
    ...
    id: 5,
    logo: `${process.env.PUBLIC_PATH}/csm_Czechglobe-logo-en_eca708c0ac.png`,
    alt: 'CzechGlobe logo',
    content: 'Global Change Research Institute',
    href: 'www.czechglobe.cz'
  },
  {
    name: 'Norwegian Research Centre',
    id: 6,
    logo: `${process.env.PUBLIC_PATH}/norce-logo.png`,
    alt: 'NORCE logo',
    content:
  ...
  },
  {
    ...
    id: 7,
    logo: `${process.env.PUBLIC_PATH}/Uni-Bergen-emblem.png`,
  ...
  },
  {
    ...
    id: 8,
    logo: `${process.env.PUBLIC_PATH}/csm_tropos_logo.png`,
    alt: 'Leibniz Institute for Tropospheric Research logo',
    content: 'Leibniz Institute for Tropospheric Research',
    href: 'http://www.tropos.de/'
  },
  {
    name: 'Geomar Helmholtz Centre for Ocean Research Kiel',
    id: 9,
    logo: `${process.env.PUBLIC_PATH}/Geomar_logo.png`,
    alt: 'Geomar Helmholtz Centre for Ocean Research Kiel logo',
    content: 'Geomar Helmholtz Centre for Ocean Research Kiel',
    href: 'http://www.geomar.de/en/forschen/fb2/fb2-ch/ueberblick/'
  },
  {
    name: 'SAEON',
    id: 10,
    logo: `${process.env.PUBLIC_PATH}/saeon-logo.png`,
    alt: 'SAEON logo',
    content: 'South African Environmental Observation Network',
    href: 'http://www.saeon.ac.za'
  },
  {
    name: 'Trinity College Dublin',
    id: 11,
    logo: `${process.env.PUBLIC_PATH}/trinity-dublin-logo.png`,
    alt: 'Trinity College Dublin logo',
    content: 'Trinity College Dublin',
    href: 'http://naturalscience.tcd.ie/'
  },
  {
    name: 'University of the Witwatersrand Johannesburg',
    id: 12,
    logo: `${process.env.PUBLIC_PATH}/wits-logo.png`,
    alt: 'WITS logo',
    content: 'University of the Witwatersrand Johannesburg',
    href: 'https://www.wits.ac.za'
  },
  {
    name: 'Integrated Carbon Observation System',
    id: 13,
    logo: `${process.env.PUBLIC_PATH}/icos-logo.png`,
    alt: 'ICOS logo',
    content: 'Integrated Carbon Observation System',
    href: 'https://www.icos-ri.eu/'
  },
  {
    name: 'International Livestock Research Institute',
    id: 14,
    logo: `${process.env.PUBLIC_PATH}/ilir.png`,
    alt: 'ilir logo',
  ...
  },
  {
    name: 'WASCAL',
    id: 15,
    logo: `${process.env.PUBLIC_PATH}/wascal-logo.png`,
    alt: 'West Africa Science Center on Climate Change and Adapted Land Use logo',
    content: 'West Africa Science Center on Climate Change and Adapted Land Use',
    href: 'http://wascal.org/'
  },
  {
    name: 'Euro-Mediterranean Center on Climate Change',
    id: 16,
    logo: `${process.env.PUBLIC_PATH}/csm_CMCCorizzontaleCOLORE_029a50c0fc.gif`,
  ...
  },
  {
    ...
    id: 17,
    logo: `${process.env.PUBLIC_PATH}/thuenen_web_logo_transparent.png`,
    alt: 'Thuenen logo',
  ...
  },
  {
    name: 'SASSCAL',
    id: 18,
    logo: `${process.env.PUBLIC_PATH}/sasscal-logo.png`,
    alt: 'SASSCAL logo',
