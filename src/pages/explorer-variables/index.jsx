                ...
                <Cell size={12}>
                  <ExpansionList>
                    ...
                    <ExpansionPanel label="Role of variable in Radiative Forcing" footer={false}>
                      <p>
                        Below figures are simple aggregates of global figures from the IPCC 5th Assessment Report and are only meant to provide a very
                        coarse guidance with regards to sign and magnitude of uncertainty of the variable's contribution to radiative forcing on the
