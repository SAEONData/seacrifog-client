                ...
                menuItems={(() => {
                  const protocolsList = v.protocols
                    .map(p => {
                      ...
                      const doiFound = search === '' ? true : p.doi.toUpperCase().indexOf(search) >= 0 ? true : false
                      const titleFound = search === '' ? true : p.title.toUpperCase().indexOf(search) >= 0 ? true : false
                      const authorFound = search === '' ? true : p.author.toUpperCase().indexOf(search) >= 0 ? true : false
                      const publisherFound = search === '' ? true : p.publisher.toUpperCase().indexOf(search) >= 0 ? true : false
